...
render(){
    return (
        <View style={style.wrap}>
            ...
            <View style={{width:width*0.07,borderColor:'#D3D3D3',borderBottomWidth:1,borderTopWidth:1}}>
            <TextInput style={{top:0,padding:0,height:28,textAlign:'center'}}  keyboardType='numeric' maxLength={4}  value={this.props.num.toString()} onChangeText={(num)=>{this.changeNumHandle(num)}}/></View>
            <View style={style.btn}>
