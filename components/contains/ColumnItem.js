...
export default function({item}){
    ...
    return (
        ...
        />
       <View>
       <Text style={{marginLeft:10,overflow:'hidden',width:width*0.6,height:20,fontSize:15,color:'black',marginTop:10}}>{item.name}</Text>
        <Text style={{marginLeft:10,width:width*0.6,height:33,fontSize:13,marginTop:10}}>{item.subtitle}</Text>
